      ...
      <div className="relative container mx-auto flex flex-col gap-[20px]">
        ...
        <div className="w-full flex flex-col justify-center gap-5 pt-4">
          {PRICEING_RULES.map((text, index) => (
            <div
              className="relative max-w-[500px] w-full h-[40px] mx-auto flex items-center px-[20px] shadow after:absolute after:top-1/2 after:-translate-1/2 after:left-[5px] after:w-[5px] after:h-[5px] after:rounded-full after:bg-[var(--primary)]"
              key={index}
            >
              {text}
            </div>
